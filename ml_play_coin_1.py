class MLPlay:
    ...
    def update(self, scene_info):
            ...
            for i in range(n):
                for car in scene_info["cars_info"]:
                    if car["id"] == Pcar[i]:
                        ...
                        if abs(self.car_pos[0]-Pcar_pos[0]) < 60 and self.car_pos[1]-Pcar_pos[1] < 120 and self.car_pos[1]-Pcar_pos[1] > 0: too_close = 1
        ...
        if mid_lane != 0:
                    ...
                    for car in scene_info["cars_info"]:
                        if car["id"] == Bcar[i]:
                            ...
                            if trans_pos == self.car_pos[0] and self.car_pos[1]-Bcar_pos[1] > 0:
                                ...
                                if lane_dis[mid_lane-1] < 120: front_banner = 1
            ...
            if near_coin != 1000000 and abs(self.car_pos[0]-near_coin_x) < 210 and self.car_pos[1]-near_coin_y < 240 and self.car_pos[1]-near_coin_y > -40:
                chase_coin = 1
            ...
            if too_fast == 1 or too_close==1 : return ["BRAKE"]
